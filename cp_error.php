        ...
        <div class="col-md-12">
            <div class="alert alert-danger-alt alert-dismissable">
                ...
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">
                    ×</button><strong>Error!</strong> Your password and confirm password do not match. Please try again</div>
        </div>
    </div>
</div>
        ...
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="tab-pane active" id="register">
              <form class="form-signin" action="core/register.php" method="POST">
                ...
                <input type="submit" name="regiter" class="btn btn-lg btn-default btn-block" value="Sign Up" />
              </form>
              <div id="tabs" data-tabs="tabs">
